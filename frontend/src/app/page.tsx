  ...
  return (
    <main>
      <div className="flex h-full w-full flex-col p-8 items-center">
        ...
        />
        <div>
          <h1 className="text-center text-4xl font-[350] my-30">Selecciona una marca para ver sus preguntas frecuentes</h1>
        </div>
        <div className="grid grid-cols-2 gap-x-16 gap-y-10">
          {brands.map((brand) => (
            <div key={brand.id} className="opacity-0 animate-fadein drop-shadow-xl bg-white px-8 py-4 rounded-xl transition hover:scale-110 hover:drop-shadow-3xl">
              <Image 
                alt={brand.name}
                src={brand.imageUrl}
                width={200}
